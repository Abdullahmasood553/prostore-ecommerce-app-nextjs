...
export const insertProductSchema = z.object({
    name: z.string().min(3, 'Name must be atlast 3 characters'),
    slug: z.string().min(3, 'Slug must be atlast 3 characters'),
    category: z.string().min(3, 'Category must be atlast 3 characters'),
    brand: z.string().min(3, 'Brand must be atlast 3 characters'),
    description: z.string().min(3, 'Description must be atlast 3 characters'),
    stock: z.coerce.number(),
    images: z.array(z.string()).min(1, 'Porudct must have at least image'),
...
export const cartItemSchema = z.object({
  ...
  qty: z.number().nonnegative('Quantity must be positive number'),
